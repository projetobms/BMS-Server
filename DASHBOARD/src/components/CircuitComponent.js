...
const CircuitComponent = ({
    ...
    <div style={{ position: 'relative', width: '1366px', height: '682px' }}>
    <svg width="1366" height="682" viewBox="0 0 1366 682" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M511.084 389.854V407.401L511.769 407.652C515.653 409.036 518.592 412.423 519.464 416.502C519.758 417.877 519.758 420.114 519.473 421.434C518.387 426.331 514.664 429.97 509.837 430.841C508.723 431.039 506.853 431.039 505.74 430.841C502.017 430.167 498.811 427.759 497.128 424.363C496.647 423.402 496.353 422.566 496.112 421.434C495.818 420.105 495.818 417.868 496.112 416.502C496.985 412.423 499.924 409.036 503.798 407.652L504.493 407.401V389.854V372.299V372.299C505.368 368.855 510.309 368.831 511.084 372.299V372.299V389.854Z" fill="#FF3838"/>
    ...
    <text x="250" y="340" font-size="25" font-family='Arial' text-anchor="middle" fill="white">
        <tspan x="280" dy="0" >{BatteryVoltage} V</tspan>
        <tspan x="280" dy="1.2em">{BatteryTemperature} ºC</tspan>
    </text>
</svg>
<input
      type="text"
