...
const CircuitComponent = ({
    ...
    <rect x="504.8" y={327+90*(1-(ChamberTemperature+100)/800)} width="6.6" height={90*((ChamberTemperature+100)/800)} rx="3.3" fill="#FF3838"/>
    ...
    <text x="595" y="360" font-size="25" font-family='Arial' text-anchor="middle" fill="white">
        {(ChamberTemperature/10).toFixed(1)} ºC
    </text>
...
<input
      type="text"
      defaultValue={ChamberSetpoint/10}
      style={{
        position: 'absolute',
        top: '335px',
        left: '395px',
