...
NODE_ADDRESSES = {
    0: "ns=1;s=esp.battery.voltage",
    1: "ns=1;s=esp.battery.temperature",
    2: "ns=1;s=esp.battery.current",
    3: "ns=1;s=esp.battery.SOC"
}
...
async def start_tcp_server(opcua_client, host='0.0.0.0', port=8086):
